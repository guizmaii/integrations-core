...
class KubernetesState(PrometheusCheck):
    ...
    def __init__(self, name, init_config, agentConfig, instances=None):
        ...
        if self.send_pod_phase_service_checks:
            self.warning('DEPRECATION NOTICE: pod phase service checks are deprecated.'
                         'Please set send_pod_phase_service_checks to false and rely on corresponding gauges instead')
